...
var CardNumberValidator = function (_React$PureComponent) {
  ...
  function CardNumberValidator() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CardNumberValidator.__proto__ || Object.getPrototypeOf(CardNumberValidator)).call.apply(_ref, [this].concat(args))), _this), _this.state = (0, _stateUtils.getEmptyState)(), _this.formatCardNumber = (0, _utils.ifElse)(_this.props.format, [_ccNumberFormatter.formatCardNumber, _utils.identity]), _this.getValidationState = function (cardNumber) {
      return (0, _utils.ifElse)(!!cardNumber, [(0, _utils.compose)((0, _stateUtils.validationToState)(cardNumber), (0, _utils.validateCardType)(_this.props.validCardTypes), _utils.validateCardNumber), _stateUtils.getEmptyState])(cardNumber);
      ...
      return (0, _utils.compose)((0, _stateUtils.setState)(_this), _this.getValidationState, _this.formatCardNumber)(cardNumber);
